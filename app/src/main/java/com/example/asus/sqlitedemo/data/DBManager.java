package com.example.asus.sqlitedemo.data;
...
import com.example.asus.sqlitedemo.model.Student;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by ASUS on 11/05/17.
 */
...
public class DBManager extends SQLiteOpenHelper {
    ...
    public void addStudent(Student student) {
        ...
        //kho the luu truc tiep. noi de truyen du lieu vao de luu xun content values
        ContentValues values = new ContentValues();
        //put gia tri cua value
        ...
        //insert/ truyen vao ten bang, null, values
